...
export default {
    ...
    registerUser: async (values) => await instance.post('user/register', values),
    ...
    deleteInventory: async (compositeKey) => await instance.post('inventory/delete', compositeKey, config()),
    ...
    readDeliveries: async (date) => await instance.get(`order/delivery${date ? '?before=' + date : ""}`, config()),
